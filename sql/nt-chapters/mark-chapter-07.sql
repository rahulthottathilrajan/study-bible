...
-- MARK CHAPTER 7 — BACKFILL (additional word_studies + cross_references)
...
JOIN books b ON c.book_id = b.id
CROSS JOIN (VALUES
  (1, 'ἀπὸ Ἱεροσολύμων', 'apo Hierosolymōn', 'G2414', 'From Jerusalem — official inquisitorial delegation travelling ~90 miles north; escalates the conflict from local Galilean Pharisees to Jerusalem establishment.', 100),
  (2, 'ἀνίπτοις', 'aniptois', 'G449', 'Unwashed — alpha-privative of niptō; technical term for ritually (not hygienically) unpurified; Mark immediately glosses the word for Gentile readers.', 101),
  (3, 'πυγμῇ', 'pygmē', 'G4435', 'With the fist — obscure adverb; possibly "up to the wrist" or "carefully"; describes the prescribed scrubbing motion in pharisaic halakha.', 102),
  (3, 'κρατοῦντες τὴν παράδοσιν', 'kratountes tēn paradosin', 'G2902/G3862', 'Holding fast the tradition — kratountes: clutching tightly; paradosis: what is "handed over" from teacher to disciple; technical rabbinic vocabulary.', 103),
  (4, 'ἀπὸ ἀγορᾶς', 'apo agoras', 'G58', 'From the marketplace — coming from public space risked Gentile contact; prompts whole-body immersion before eating.', 104),
  (4, 'βαπτισμοὺς ποτηρίων καὶ ξεστῶν', 'baptismous potēriōn kai xestōn', 'G909/G4221/G3582', 'Washings of cups and pitchers — xestēs: Latin sextarius (~half litre); Mark preserves Roman/Jewish domestic vocabulary.', 105),
  (5, 'κοιναῖς χερσίν', 'koinais chersin', 'G2839', 'With common/defiled hands — Mark signposts the whole dietary controversy: "common" here denotes ritual impurity, not simply ordinary.', 106),
  (6, 'καλῶς ἐπροφήτευσεν', 'kalōs eprophēteusen', 'G2573/G4395', 'Well did [Isaiah] prophesy — ironic use of kalōs (bullseye accuracy); Jesus weaponises the LXX against his interrogators.', 107),
  (6, 'τοῖς χείλεσίν ... ἡ δὲ καρδία', 'tois cheilesin ... hē de kardia', 'G5491/G2588', 'With the lips ... but the heart — Isa 29:13 LXX; Mark highlights external-internal antithesis that controls the whole pericope.', 108),
  (6, 'πόρρω ἀπέχει', 'porrō apechei', 'G4206/G568', 'Is far distant — spatial metaphor for relational estrangement from God despite ritual proximity.', 109),
  (7, 'ἐντάλματα ἀνθρώπων', 'entalmata anthrōpōn', 'G1778/G444', 'Commandments of men — entalma: human injunction; contrasted with entolai tou theou (v.8); all man-made halakha weighed against divine command.', 110),
  (8, 'ἀφέντες ... κρατεῖτε', 'aphentes ... krateite', 'G863/G2902', 'Having let go ... you hold fast — chiastic verbs: release God''s command, grip man''s tradition; inversion of covenant priorities.', 111),
  (9, 'καλῶς ἀθετεῖτε', 'kalōs atheteite', 'G2573/G114', 'Beautifully you reject — biting irony; kalōs now sarcastic; Pharisees are "expert" at voiding divine commands.', 112),
  (10, 'ὁ κακολογῶν', 'ho kakologōn', 'G2551', 'He who reviles — compound of kakos + logos; not mild disrespect but cursing one''s parent, a capital offence in Exod 21:17.', 113),
  (11, 'ὃ ἐὰν ἐξ ἐμοῦ ὠφεληθῇς', 'ho ean ex emou ōphelēthēs', 'G5623', 'Whatever thou mightest benefit from me — formulaic vow clause releasing property from parental claim via token dedication to Temple.', 114),
  (11, 'κορβᾶν, ὅ ἐστιν δῶρον', 'korban, ho estin dōron', 'G2878/G1435', 'Korban, that is, gift — Mark glosses the Hebrew/Aramaic term (qorbān, "offering" Lev 1-7); the pharisaic loophole is technical but exploited.', 115),
  (12, 'οὐκέτι ἀφίετε', 'ouketi aphiete', 'G863', 'You no longer permit — the halakhic ruling positively forbids what the Fifth Commandment positively commands; Torah contradiction made manifest.', 116),
  (13, 'ἀκυροῦντες τὸν λόγον', 'akyrountes ton logon', 'G208', 'Invalidating the word — akyroō: legal term for annulling a contract; tradition operates as counter-legislation against Scripture.', 117),
  (13, 'παρόμοια τοιαῦτα πολλά', 'paromoia toiauta polla', 'G3946', 'Many such-like things — paromoios: parallel/analogous; korban is one example of a systemic pattern.', 118),
  (14, 'προσκαλεσάμενος τὸν ὄχλον', 'proskalesamenos ton ochlon', 'G4341/G3793', 'Having summoned the crowd — Jesus moves from private rebuke of Pharisees to public instruction of the masses; halakhic debate becomes gospel proclamation.', 119),
  (15, 'εἰσπορευόμενον ... ἐκπορευόμενα', 'eisporeuomenon ... ekporeuomena', 'G1531/G1607', 'Going in ... coming out — spatial verbs form the chiasm; Mark contrasts stomach route with heart route.', 120),
  (17, 'ἐπηρώτων αὐτὸν τὴν παραβολήν', 'epērōtōn auton tēn parabolēn', 'G1905/G3850', 'Asked him the parable — disciples treat the saying as a mashal requiring private exposition; 4:10 pattern repeats.', 121),
  (18, 'οὕτως καὶ ὑμεῖς ἀσύνετοί ἐστε', 'houtōs kai hymeis asynetoi este', 'G801', 'Are you also so without understanding? — asynetoi: dull, uncomprehending; same adjective Paul uses of fallen humanity in Rom 1:31.', 122),
  (19, 'εἰς τὸν ἀφεδρῶνα', 'eis ton aphedrōna', 'G856', 'Into the latrine — euphemistic for the privy; Mark''s frank physiology underscores the absurdity of dietary-impurity theology.', 123),
  (19, 'καθαρίζων πάντα τὰ βρώματα', 'katharizōn panta ta brōmata', 'G2511/G1033', 'Cleansing all foods — parenthetical masculine participle agreeing with Jesus, not the latrine; anchors NT abrogation of Levitical dietary code.', 124),
  (20, 'ἐκεῖνο κοινοῖ τὸν ἄνθρωπον', 'ekeino koinoi ton anthrōpon', 'G2840', 'That defiles the person — koinoō: to make common/unclean; verbal cousin of koinos, bridging v.2 and v.5 vocabulary.', 125),
  (21, 'ἔσωθεν ἐκ τῆς καρδίας', 'esōthen ek tēs kardias', 'G2081/G2588', 'From within, out of the heart — Mark''s spatial logic: defilement moves outward from heart, not inward from food.', 126),
  (21, 'διαλογισμοὶ οἱ κακοί', 'dialogismoi hoi kakoi', 'G1261', 'Evil reasonings — headline of a 12-item vice catalogue; six in plural (evil kinds), six in singular (abstract qualities).', 127),
  (22, 'πλεονεξίαι', 'pleonexiai', 'G4124', 'Covetousness — plural of the cardinal vice Paul equates with idolatry (Col 3:5); relentless grasping for more.', 128),
  (22, 'ὀφθαλμὸς πονηρός', 'ophthalmos ponēros', 'G3788/G4190', 'Evil eye — Semitic idiom for envy, stinginess, grudging spirit (Deut 15:9); not merely a superstitious gaze.', 129),
  (22, 'βλασφημία, ὑπερηφανία', 'blasphēmia, hyperēphania', 'G988/G5243', 'Slander, arrogance — the Godward and humanward sins of proud speech paired; hyperēphania: showing oneself above others.', 130),
  (24, 'εἰς τὰ ὅρια Τύρου', 'eis ta horia Tyrou', 'G3725/G5184', 'Into the region of Tyre — Phoenician coastal territory; Jesus deliberately enters Gentile land (cf. Joel 3:4 Tyre oracle).', 131),
  (24, 'ἤθελεν λαθεῖν', 'ēthelen lathein', 'G2990', 'Wanted to escape notice — Mark''s recurrent theme of Jesus seeking anonymity; impossible because fame precedes him.', 132),
  (25, 'πνεῦμα ἀκάθαρτον', 'pneuma akatharton', 'G4151/G169', 'Unclean spirit — Markan preferred idiom; doubly "common" — Gentile territory, unclean spirit, Gentile child — ritually maximal impurity.', 133),
  (26, 'Ἑλληνίς, Συροφοινίκισσα τῷ γένει', 'Hellēnis, Syrophoinikissa tō genei', 'G1674/G4949', 'Greek, Syrophoenician by race — doubly Gentile: Hellenised culture + Phoenician ethnicity within Roman Syria; Mark stresses her outsider status.', 134),
  (27, 'ἄφες πρῶτον χορτασθῆναι τὰ τέκνα', 'aphes prōton chortasthēnai ta tekna', 'G863/G4412/G5526', 'Let the children first be filled — prōton: salvation-historical order (Rom 1:16); Jesus tests, does not deny, Gentile inclusion.', 135),
  (28, 'ναί, κύριε', 'nai, kyrie', 'G3483/G2962', 'Yes, Lord — unique in Mark: the only petitioner to address Jesus as kyrios; her faith sharpens his metaphor against himself.', 136),
  (28, 'ἀπὸ τῶν ψιχίων τῶν παιδίων', 'apo tōn psichiōn tōn paidiōn', 'G5589/G3813', 'Of the children''s crumbs — psichia: diminutive of psix, tiny breadcrumbs; paidiōn: "little children," matching kynariois "little dogs".', 137),
  (29, 'διὰ τοῦτον τὸν λόγον', 'dia touton ton logon', 'G1223/G3056', 'Because of this word — her utterance of faith, not her ethnic pedigree, unlocks the exorcism; word-faith dynamic foregrounded.', 138),
  (31, 'ἀνὰ μέσον τῶν ὁρίων Δεκαπόλεως', 'ana meson tōn horiōn Dekapoleōs', 'G1179', 'Through the midst of the Decapolis region — Gentile ten-city federation east/SE of Galilee; Jesus arcs through pagan lands.', 139),
  (32, 'κωφὸν μογιλάλον', 'kōphon mogilalon', 'G2974/G3424', 'Deaf, having speech impediment — mogilalos NT hapax, occurring in LXX Isa 35:6; Mark quietly signals messianic-era fulfilment.', 140),
  (33, 'βάλων τοὺς δακτύλους αὐτοῦ εἰς τὰ ὦτα', 'balōn tous daktylous autou eis ta ōta', 'G906/G1147/G3775', 'Having put his fingers into the ears — tactile sign-language communication with deaf man; Jesus "speaks" in the only language the man can receive.', 141),
  (33, 'πτύσας ἥψατο τῆς γλώσσης', 'ptysas hēpsato tēs glōssēs', 'G4429/G681/G1100', 'Having spat, touched the tongue — saliva had perceived therapeutic value in ancient medicine; incarnational, earthy healing theology.', 142),
  (34, 'ἀναβλέψας ... ἐστέναξεν', 'anablepsas ... estenaxen', 'G308/G4727', 'Looking up ... he groaned — stenazō: deep sigh expressing grief at creation''s brokenness (Rom 8:22-23 echo).', 143),
  (34, 'Ἐφφαθά ... διανοίχθητι', 'Ephphatha ... dianoichthēti', 'G2188/G1272', 'Ephphatha ... be opened — Aramaic ''ithpattach preserved then translated; Mark alone retains Jesus''s ipsissima verba (cf. 5:41; 14:36; 15:34).', 144),
  (35, 'ἐλύθη ὁ δεσμὸς τῆς γλώσσης', 'elythē ho desmos tēs glōssēs', 'G3089/G1199/G1100', 'The bond of his tongue was loosed — desmos: Satanic bondage language (cf. Luke 13:16); healing portrayed as liberation from spiritual captivity.', 145),
  (36, 'διεστέλλετο ... μᾶλλον περισσότερον', 'diestelleto ... mallon perissoteron', 'G1291/G3123', 'Charged them ... all the more abundantly — Mark''s sharpest statement of the messianic-secret/publicity paradox.', 146),
  (37, 'ὑπερπερισσῶς', 'hyperperissōs', 'G5249', 'Beyond all measure — hapax NT; compound hyper-intensive; Mark''s taste for amplification to convey crowd astonishment.', 147),
  (37, 'καλῶς πάντα πεποίηκεν', 'kalōs panta pepoiēken', 'G2573/G4160', 'All things he has done well — perfect tense; echoes LXX Gen 1:31 kala lian; creation-renewal framing of Jesus''s ministry.', 148)
) AS w(verse_number, original_word, transliteration, strongs_number, meaning, word_order)
WHERE b.name = 'Mark' AND c.chapter_number = 7 AND v.verse_number = w.verse_number
...
CROSS JOIN (VALUES
  ...
  (1, 'Matthew 23:2', 101),
  (2, 'Luke 11:38', 102),
  (3, 'Galatians 1:14', 103),
  (4, 'Leviticus 11:32-35', 104),
  (4, 'Hebrews 9:10', 105),
  (5, '1 Peter 1:18', 106),
  (6, 'Ezekiel 33:31', 107),
  (6, '2 Timothy 3:5', 108),
  (7, 'Isaiah 29:13', 109),
  (8, 'Nehemiah 9:16', 110),
  (8, 'Jeremiah 7:23-24', 111),
  (10, 'Ephesians 6:2-3', 112),
  (10, 'Proverbs 20:20', 113),
  (11, 'Proverbs 28:24', 114),
  (11, 'Leviticus 1:2', 115),
  (12, '1 Timothy 5:4', 116),
  (13, 'Galatians 3:17', 117),
  (13, 'Isaiah 8:20', 118),
  (14, 'Mark 4:9', 119),
  (14, 'Mark 4:23', 120),
  (15, 'Titus 1:15', 121),
  (16, 'Matthew 11:15', 122),
  (18, 'Mark 4:13', 123),
  (18, 'Mark 8:17-21', 124),
  (19, 'Acts 11:9', 125),
  (19, 'Hebrews 13:9', 126),
  (20, 'Matthew 12:34-35', 127),
  (21, 'Proverbs 4:23', 128),
  (21, 'Matthew 15:19', 129),
  (21, 'James 1:14-15', 130),
  (22, 'Matthew 20:15', 131),
  (22, 'Deuteronomy 15:9', 132),
  (22, 'Proverbs 22:15', 133),
  (22, 'Romans 1:29-30', 134),
  (23, '1 Peter 2:1', 135),
  (24, 'Matthew 15:22', 136),
  (24, 'Joshua 19:28-29', 137),
  (25, 'Mark 5:2', 138),
  (25, 'Mark 5:22-23', 139),
  (26, 'Acts 21:3', 140),
  (27, 'Romans 9:4', 141),
  (27, 'Romans 15:8', 142),
  (28, 'Philippians 3:2', 143),
  (28, 'Ephesians 2:12-13', 144),
  (29, 'Mark 5:8', 145),
  (30, 'Matthew 15:28', 146),
  (31, 'Mark 5:20', 147),
  (31, 'Matthew 15:29-31', 148),
  (32, 'Isaiah 35:6', 149),
  (33, 'Mark 8:23', 150),
  (33, 'John 9:6', 151),
  (34, 'Mark 8:12', 152),
  (34, 'John 11:33', 153),
  (34, 'Romans 8:22-23', 154),
  (35, 'Acts 2:4', 155),
  (35, 'Isaiah 32:4', 156),
  (36, 'Mark 1:44', 157),
  (36, 'Mark 5:43', 158),
...
WHERE b.name = 'Mark' AND c.chapter_number = 7 AND v.verse_number = x.verse_number
ON CONFLICT DO NOTHING;
