...
-- MARK CHAPTER 9 — BACKFILL (additional word_studies + cross_references)
...
JOIN books b ON c.book_id = b.id
CROSS JOIN (VALUES
  (1, 'οὐ μὴ γεύσωνται θανάτου', 'ou mē geusōntai thanatou', 'G1089/G2288', 'Shall not taste death — ou mē: emphatic double negative + subjunctive; Semitic idiom for personal experiencing; some in audience will witness kingdom-power.', 100),
  (1, 'ἐληλυθυῖαν ἐν δυνάμει', 'elēlythuian en dynamei', 'G2064/G1411', 'Having come with power — perfect participle: already-arrived state; Mark places the Transfiguration next as anticipatory proof.', 101),
  (2, 'μεθ᾽ ἡμέρας ἕξ', 'meth hēmeras hex', 'G2250/G1803', 'After six days — precise chronological marker; mirrors Moses'' six-day cloud cover on Sinai (Exod 24:16); seventh-day theophany pattern.', 102),
  (2, 'εἰς ὄρος ὑψηλὸν κατ᾽ ἰδίαν', 'eis oros hypsēlon kat idian', 'G3735/G5308/G2596', 'Onto a high mountain apart — classic theophanic geography (Sinai, Horeb, Zion); Mt Hermon (9288 ft) likely, near Caesarea Philippi.', 103),
  (3, 'στίλβοντα λευκὰ λίαν', 'stilbonta leuka lian', 'G4744/G3029', 'Shining exceeding white — stilbō (NT hapax): flash like polished metal; Mark emphasises glory-radiance beyond natural whiteness.', 104),
  (3, 'οἷα γναφεὺς ἐπὶ τῆς γῆς οὐ δύναται', 'hoia gnapheus epi tēs gēs ou dynatai', 'G1102', 'Such as no fuller on earth can whiten — gnapheus: cloth-cleaner by fulling-earth; Mark''s earthy domestic comparison amplifies heavenly origin.', 105),
  (4, 'συλλαλοῦντες τῷ Ἰησοῦ', 'syllalountes tō Iēsou', 'G4814', 'Talking with Jesus — imperfect; Luke 9:31 adds topic: his exodos in Jerusalem; law + prophets authenticate passion-mission.', 106),
  (5, 'ῥαββί', 'rhabbi', 'G4461', 'Rabbi — Peter''s Aramaic honorific (used elsewhere only in 11:21, 14:45); first use signals inadequate understanding at peak revelation.', 107),
  (5, 'ποιήσωμεν τρεῖς σκηνάς', 'poiēsōmen treis skēnas', 'G4633', 'Let us make three tabernacles — skēnē: Feast of Booths/Sukkot shelter; Peter wants to institutionalise the moment, eschatological Sukkot consummation.', 108),
  (6, 'ἔκφοβοι ἐγένοντο', 'ekphoboi egenonto', 'G1630', 'They became terrified — ek-phobos: fully gripped by fear; NT appearances only here and Heb 12:21 (Sinai).', 109),
  (7, 'νεφέλη ἐπισκιάζουσα αὐτοῖς', 'nephelē episkiazousa autois', 'G3507/G1982', 'A cloud overshadowing them — episkiazō: LXX term for shekhinah (Exod 40:35; Num 9:18); same verb in Luke 1:35 for Mary.', 110),
  (7, 'ἀκούετε αὐτοῦ', 'akouete autou', 'G191', 'Hear him — Deut 18:15 prophet-like-Moses formula; Jesus receives the obedience owed exclusively to Yahweh''s spokesman.', 111),
  (8, 'οὐκέτι οὐδένα ... εἰ μὴ τὸν Ἰησοῦν', 'ouketi oudena ... ei mē ton Iēsoun', 'G3765/G3762', 'No longer anyone ... except Jesus — triple negative + exception; law-and-prophets recede, leaving the Son as sole focus of revelation.', 112),
  (9, 'διεστείλατο αὐτοῖς ἵνα μηδενὶ διηγήσωνται', 'diesteilato autois hina mēdeni diēgēsōntai', 'G1291/G1334', 'Charged them that they should tell no one — diastellō: strict injunction; temporal clause "until the Son of Man be risen" sets explicit expiry.', 113),
  (10, 'τὸν λόγον ἐκράτησαν πρὸς ἑαυτούς', 'ton logon ekratēsan pros heautous', 'G2902/G3056', 'Kept the word to themselves — kratēsan: held fast; disciples practise the secrecy command but are puzzled by resurrection talk.', 114),
  (11, 'δεῖ ἐλθεῖν πρῶτον', 'dei elthein prōton', 'G1163/G2064/G4412', 'Must come first — dei: divine necessity; same word as 8:31 passion-must; scribal eschatology tied Elijah to Messiah''s advent.', 115),
  (12, 'ἀποκαθιστάνει πάντα', 'apokathistanei panta', 'G600', 'Restores all things — apocatastasis: full restoration (Mal 4:6); same verbal family as Acts 3:21 eschatological renewal.', 116),
  (12, 'ἐξουδενηθῇ', 'exoudenēthē', 'G1847', 'Set at nought — compound of ouden (nothing); reduce to nothing; direct Isa 53:3 LXX echo.', 117),
  (14, 'γραμματεῖς συζητοῦντας', 'grammateis syzētountas', 'G1122/G4802', 'Scribes disputing — syzēteō: contentious debate; disciples'' failure has become fodder for scholarly criticism.', 118),
  (15, 'ἐξεθαμβήθη', 'exethambēthē', 'G1568', 'Were greatly amazed — aorist passive of ekthambeō; stronger than thambeō; Mark''s favourite awe-verb (used also 14:33; 16:5, 6).', 119),
  (17, 'πνεῦμα ἄλαλον', 'pneuma alalon', 'G4151/G216', 'A mute spirit — alpha-privative of laleō; possession categorised by symptom rather than name; Jesus will later identify it as deaf as well (v.25).', 120),
  (18, 'ξηραίνεται', 'xērainetai', 'G3583', 'Pines away / becomes rigid — xēraino: to dry up; post-seizure catatonia; medically precise description of epilepsy-like episodes.', 121),
  (18, 'ἀφρίζει καὶ τρίζει τοὺς ὀδόντας', 'aphrizei kai trizei tous odontas', 'G875/G5149', 'Foams and grinds the teeth — aphrizō (NT hapax) + trizō (NT hapax): Mark uses three hapaxes for this scene''s clinical detail.', 122),
  (19, 'ὦ γενεὰ ἄπιστος', 'ō genea apistos', 'G5599/G1074/G571', 'O faithless generation — prophetic lament formula (cf. Isa 6:5); "generation" targets wider Israel, not just disciples.', 123),
  (19, 'ἕως πότε πρὸς ὑμᾶς ἔσομαι', 'heōs pote pros hymas esomai', 'G2193/G4219', 'How long shall I be with you — double temporal question; Jesus expresses divine weariness (echoes Num 14:27; Deut 32:20).', 124),
  (20, 'συνεσπάραξεν αὐτόν', 'synesparaxen auton', 'G4952', 'Convulsed him — syn-intensive of sparassō (cf. 1:26); the demon violently manifests at Christ''s presence, public testimony.', 125),
  (22, 'σπλαγχνισθεὶς βοήθησον ἡμῖν', 'splanchnistheis boēthēson hēmin', 'G4697/G997', 'Have compassion on us and help us — father identifies himself with the son''s plight: "help us," not just the boy.', 126),
  (23, 'τὸ εἰ δύνῃ', 'to ei dynē', 'G1410', 'As to your "If thou canst" — Jesus repeats the father''s conditional back at him; definite article transforms it into a cited phrase.', 127),
  (23, 'πάντα δυνατὰ τῷ πιστεύοντι', 'panta dynata tō pisteuonti', 'G1415/G4100', 'All things [are] possible for the one who believes — dative of agency; faith in Christ''s power is the enabling conduit.', 128),
  (24, 'κράξας ... μετὰ δακρύων', 'kraxas ... meta dakryōn', 'G2896/G1144', 'Crying out with tears — some mss omit "with tears"; Mark''s emotional realism captures limits-of-faith honesty.', 129),
  (25, 'ἐπισυντρέχει ὄχλος', 'episyntrechei ochlos', 'G1998/G3793', 'A crowd ran together — double compound (epi + syn + trechō); crowd convergence forces Jesus to act before spectacle spins out.', 130),
  (25, 'ἐγὼ ἐπιτάσσω σοι', 'egō epitassō soi', 'G1473/G2004', 'I command you — emphatic "I"; epitassō: authoritative military-style command; sharper than the 5:8 exchange.', 131),
  (25, 'μηκέτι εἰσέλθῃς εἰς αὐτόν', 'mēketi eiselthēs eis auton', 'G3371/G1525', 'No longer enter into him — unique permanence clause; Jesus seals future from re-entry (cf. Matt 12:43-45).', 132),
  (26, 'ἐγένετο ὡσεὶ νεκρός', 'egeneto hōsei nekros', 'G5616/G3498', 'Became like a corpse — deliverance mimics resurrection pattern: death-appearance precedes Jesus''s raising touch (v.27).', 133),
  (28, 'κατ᾽ ἰδίαν', 'kat idian', 'G2398', 'Privately — Mark''s recurrent private-instruction motif (4:34; 7:33; 13:3); disciples'' failures teaching moments behind closed doors.', 134),
  (29, 'ἐν οὐδενὶ δύναται ἐξελθεῖν', 'en oudeni dynatai exelthein', 'G1410/G1831', 'Can come out by nothing — negative force + exception clause; Mark classifies demons by hierarchy of resistance and required spiritual discipline.', 135),
  (31, 'παραδίδοται εἰς χεῖρας ἀνθρώπων', 'paradidotai eis cheiras anthrōpōn', 'G3860/G5495', 'Is delivered into hands of men — present "divine passive": action in progress now; paradidōmi echoes LXX Isa 53:6, 12.', 136),
  (32, 'ἠγνόουν τὸ ῥῆμα', 'ēgnooun to rhēma', 'G50/G4487', 'Were ignorant of the saying — imperfect of agnoeō; disciples'' ongoing blindness despite repeated, clearer predictions.', 137),
  (32, 'ἐφοβοῦντο ἐπερωτῆσαι', 'ephobounto eperōtēsai', 'G5399/G1905', 'Feared to ask him — shame-avoidance after 8:33 rebuke; Mark''s unflattering portrait of the Twelve persists.', 138),
  (33, 'τί ἐν τῇ ὁδῷ διελογίζεσθε', 'ti en tē hodē dielogizesthe', 'G1260/G3598', 'What were you discussing on the way — dialogizomai: deliberate reasoning; hodos ("way"): discipleship-journey motif running through 8:27-10:52.', 139),
  (35, 'ἔσχατος πάντων καὶ πάντων διάκονος', 'eschatos pantōn kai pantōn diakonos', 'G2078/G1249', 'Last of all and servant of all — parallel genitives; universal servitude as the path to primacy in kingdom order.', 140),
  (36, 'ἐναγκαλισάμενος αὐτὸ', 'enagkalisamenos auto', 'G1723', 'Having taken it into his arms — NT hapax (also 10:16); Markan tender physical gesture absent from the parallels.', 141),
  (37, 'ἐν τῷ ὀνόματί μου', 'en tō onomati mou', 'G3686', 'In my name — onoma functions as locus of authority and identity; receiving a child on Christ''s authority = receiving Christ.', 142),
  (38, 'ἐκωλύομεν αὐτόν', 'ekōlyomen auton', 'G2967', 'We were hindering him — imperfect of kōlyō; John''s report of the disciples'' partisan gatekeeping; the charge leverages name-loyalty.', 143),
  (41, 'ποτίσῃ ὑμᾶς ποτήριον ὕδατος', 'potisē hymas potērion hydatos', 'G4222/G4221', 'Gives you a cup of water — smallest possible act of aid weighed as worthy of reward; Mark''s rabbinic qal-wachomer logic.', 144),
  (42, 'μύλος ὀνικὸς', 'mylos onikos', 'G3458/G3684', 'Donkey-millstone — large upper millstone turned by ass, not small hand-mill; drowning imagery amplifies gravity of stumbling little ones.', 145),
  (43, 'εἰς τὸ πῦρ τὸ ἄσβεστον', 'eis to pyr to asbeston', 'G4442/G762', 'Into the unquenchable fire — asbestos (root of English asbestos): not-extinguishable; adjective emphasising ceaseless duration.', 146),
  (47, 'μονόφθαλμον', 'monophthalmon', 'G3442', 'One-eyed — mono + ophthalmos; better to enter kingdom maimed than whole Gehenna-bound; hyperbolic severity.', 147),
  (49, 'πυρὶ ἁλισθήσεται', 'pyri halisthēsetai', 'G4442/G233', 'Shall be salted with fire — cryptic saying; combines purifying fire with preserving salt; disciple-testing fused with covenant-seasoning imagery (Lev 2:13).', 148),
  (50, 'ἔχετε ἐν ἑαυτοῖς ἅλα', 'echete en heautois hala', 'G2192/G217', 'Have salt in yourselves — imperative; peace-preserving virtue internalised; second half "be at peace with one another" glosses the metaphor.', 149)
) AS w(verse_number, original_word, transliteration, strongs_number, meaning, word_order)
WHERE b.name = 'Mark' AND c.chapter_number = 9 AND v.verse_number = w.verse_number
...
CROSS JOIN (VALUES
  ...
  (1, 'Hebrews 2:9', 101),
  (2, 'Exodus 24:16', 102),
  (2, '2 Peter 1:17-18', 103),
  (3, 'Matthew 17:2', 104),
  (3, 'Psalm 104:2', 105),
  (4, '2 Kings 2:11', 106),
  (4, 'Deuteronomy 34:5-6', 107),
  (5, '2 Peter 1:17', 108),
  (5, 'Leviticus 23:42-43', 109),
  (6, 'Luke 9:33', 110),
  (7, 'Exodus 40:34-35', 111),
  (7, 'Luke 9:34-35', 112),
  (7, 'Acts 3:22-23', 113),
  (7, 'Deuteronomy 18:18-19', 114),
  (8, 'John 1:17', 115),
  (9, 'Matthew 17:9', 116),
  (10, 'Mark 8:31', 117),
  (11, 'Matthew 17:10', 118),
  (12, 'Malachi 4:6', 119),
  (12, 'Isaiah 53:3', 120),
  (13, 'Matthew 11:14', 121),
  (13, 'Matthew 17:12', 122),
  (14, 'Mark 2:16', 123),
  (15, 'Exodus 34:29-30', 124),
  (16, 'Luke 9:41', 125),
  (17, 'Matthew 17:14-15', 126),
  (18, 'Luke 9:39', 127),
  (19, 'Luke 9:41', 128),
  (20, 'Mark 1:26', 129),
  (22, 'Matthew 17:16-17', 130),
  (23, 'Philippians 4:13', 131),
  (23, 'Matthew 19:26', 132),
  (24, 'Mark 10:52', 133),
  (25, 'Mark 5:8', 134),
  (26, 'Mark 5:35-42', 135),
  (28, 'Mark 4:34', 136),
  (29, 'Daniel 10:12-13', 137),
  (29, 'Acts 14:23', 138),
  (30, 'Matthew 17:22', 139),
  (31, 'Matthew 17:22-23', 140),
  (31, 'Isaiah 53:6', 141),
  (32, 'Luke 9:45', 142),
  (32, 'Luke 18:34', 143),
  (33, 'Matthew 17:24', 144),
  (34, 'Luke 22:24', 145),
  (35, 'John 13:14-16', 146),
  (36, 'Matthew 18:2', 147),
  (37, 'Luke 9:48', 148),
  (37, 'John 13:20', 149),
  (38, 'Numbers 11:27-28', 150),
  (39, '1 Corinthians 12:3', 151),
  (40, 'Philippians 1:18', 152),
  (41, 'Matthew 10:42', 153),
  (41, 'Hebrews 6:10', 154),
  (42, 'Romans 14:13', 155),
  (42, '1 Corinthians 8:12', 156),
  (43, 'Galatians 5:24', 157),
  (45, 'Psalm 119:101', 158),
  (47, 'Matthew 5:28-29', 159),
  (49, 'Ezekiel 43:24', 160),
  (50, 'Romans 12:18', 161),
  (50, 'Hebrews 12:14', 162)
) AS x(verse_number, reference, ref_order)
WHERE b.name = 'Mark' AND c.chapter_number = 9 AND v.verse_number = x.verse_number
ON CONFLICT DO NOTHING;
