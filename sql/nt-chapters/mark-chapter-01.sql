...
-- MARK CHAPTER 1 — BACKFILL (additional word_studies + cross_references)
...
JOIN books b ON c.book_id = b.id
CROSS JOIN (VALUES
  (1, 'ἀρχὴ', 'archē', 'G746', 'Beginning — echoes Gen 1:1 LXX and John 1:1; Mark frames the whole gospel as the "starting point" of good news, not merely an opening chapter.', 100),
  (1, 'Ἰησοῦ Χριστοῦ', 'Iēsou Christou', 'G2424/G5547', 'Of Jesus Christ — "Jesus" (Yeshua: Yahweh saves) + "Christ" (Anointed/Messiah); earliest Christian confession fused into a proper name.', 101),
  (1, 'υἱοῦ θεοῦ', 'huiou theou', 'G5207/G2316', 'Son of God — absent in some manuscripts but likely original; Mark''s thesis statement, confirmed by Father (v.11), demons (v.24), centurion (15:39).', 102),
  (2, 'ἰδοὺ ἐγὼ ἀποστέλλω τὸν ἄγγελόν μου', 'idou egō apostellō ton angelon mou', 'G2400/G649/G32', '"Behold, I send my messenger" — composite citation: Mal 3:1 + Exod 23:20 + Isa 40:3; Mark names only Isaiah, his lead prophet.', 103),
  (3, 'φωνὴ βοῶντος ἐν τῇ ἐρήμῳ', 'phōnē boōntos en tē erēmō', 'G5456/G994/G2048', 'Voice of one crying in the wilderness — Isa 40:3 LXX; John the Baptist is the herald preparing YHWH''s highway.', 104),
  (3, 'εὐθείας ποιεῖτε', 'eutheias poieite', 'G2117/G4160', 'Make straight — imagery of filling valleys and levelling hills for a royal procession; moral straightening of hearts.', 105),
  (4, 'ἔρημος', 'erēmos', 'G2048', 'Wilderness — site of Israel''s covenant formation, testing, prophetic renewal; John deliberately ministers outside temple structures.', 106),
  (4, 'μετάνοια', 'metanoia', 'G3341', 'Repentance — change of mind leading to changed life; Hebraic turning (shuv) from sin to God; prerequisite to kingdom entry.', 107),
  (4, 'ἄφεσις ἁμαρτιῶν', 'aphesis hamartiōn', 'G859/G266', 'Forgiveness of sins — aphesis: release, pardon; Jubilee language (Lev 25); John''s baptism anticipates Jesus''s blood-achieved remission.', 108),
  (6, 'τρίχας καμήλου', 'trichas kamēlou', 'G2359/G2574', 'Camel''s hair — coarse garment of prophetic austerity; evokes Elijah''s hairy mantle (2 Kgs 1:8).', 109),
  (6, 'ἀκρίδας καὶ μέλι ἄγριον', 'akridas kai meli agrion', 'G200/G3192/G66', 'Locusts and wild honey — clean food per Lev 11:22; wilderness diet signals radical separation from settled society.', 110),
  (7, 'ἰσχυρότερός μου', 'ischyroteros mou', 'G2478', 'Mightier than I — John subordinates himself absolutely; comparative of ischyros (strong, mighty).', 111),
  (7, 'λύσαι τὸν ἱμάντα', 'lysai ton himanta', 'G3089/G2438', 'To untie the strap — unloosing a master''s sandal was a slave''s task a rabbinic disciple would never do; John claims less than slave status.', 112),
  (8, 'ἐν πνεύματι ἁγίῳ', 'en pneumati hagiō', 'G4151/G40', 'In/with Holy Spirit — fulfilment of Joel 2:28, Ezek 36:27; Messiah''s distinctive baptism contrasted with water purification.', 113),
  (10, 'σχιζομένους', 'schizomenous', 'G4977', 'Being torn open — violent verb (cf. temple veil 15:38); Mark alone uses schizō here; Isa 64:1 prayer answered: "rend the heavens."', 114),
  (10, 'περιστεράν', 'peristeran', 'G4058', 'Dove — Spirit''s visible form; evokes Gen 1:2 brooding over waters; some rabbis linked dove to Israel; possible Noah/new-creation echo.', 115),
  (11, 'ἀγαπητός', 'agapētos', 'G27', 'Beloved — Isaac typology (Gen 22:2 LXX uses same word); unique, sacrificial son; Father''s direct address.', 116),
  (11, 'εὐδόκησα', 'eudokēsa', 'G2106', 'I am well pleased — aorist; Isa 42:1 servant echo; divine delight predates any public ministry.', 117),
  (12, 'ἐκβάλλει', 'ekballei', 'G1544', 'Drives out — forceful verb normally used for exorcism; the same Spirit who descended now compels Jesus into conflict.', 118),
  (13, 'πειραζόμενος ὑπὸ τοῦ σατανᾶ', 'peirazomenos hypo tou satana', 'G3985/G4567', 'Being tempted by Satan — present passive: continuous testing through 40 days; Satan: adversary, accuser.', 119),
  (13, 'μετὰ τῶν θηρίων', 'meta tōn thēriōn', 'G2342', 'With the wild beasts — only Mark notes this; new-Adam imagery (Gen 2:19-20); Isa 11:6-9 messianic peace foreshadowed.', 120),
  (13, 'διηκόνουν αὐτῷ', 'diēkonoun autō', 'G1247', 'Ministered to him — imperfect: kept on serving; angelic attendance completes paradise motif.', 121),
  (14, 'παραδοθῆναι', 'paradothēnai', 'G3860', 'To be delivered up — same verb later used of Jesus''s own handing over (9:31; 14:41); John''s fate prefigures Christ''s.', 122),
  (15, 'πεπλήρωται ὁ καιρός', 'peplērōtai ho kairos', 'G4137/G2540', 'The time is fulfilled — perfect tense: the decisive kairos has arrived and remains; Dan 9-type prophetic reckoning complete.', 123),
  (15, 'ἤγγικεν ἡ βασιλεία', 'ēngiken hē basileia', 'G1448/G932', 'The kingdom has drawn near — perfect of engizō; not merely approaching but already at arm''s length in Jesus''s person.', 124),
  (16, 'ἀμφιβάλλοντας', 'amphiballontas', 'G906', 'Casting a circle-net — amphiblēstron, small round hand-net thrown from shore/shallow water; Mark''s precise fishing vocabulary.', 125),
  (16, 'ἁλιεῖς', 'halieis', 'G231', 'Fishermen — established trade on the Sea of Galilee; Zebedee likely owned a sizeable operation (v.20).', 126),
  (17, 'δεῦτε ὀπίσω μου', 'deute opisō mou', 'G1205/G3694', '"Come after me" — rabbinic summons; disciple walks behind the master; Elijah-Elisha call pattern (1 Kgs 19:19-21).', 127),
  (17, 'ἁλιεῖς ἀνθρώπων', 'halieis anthrōpōn', 'G231/G444', 'Fishers of men — Jer 16:16 imagery; the same skills redirected to gathering the repentant for the kingdom.', 128),
  (18, 'εὐθὺς ἀφέντες τὰ δίκτυα', 'euthys aphentes ta diktya', 'G2117/G863/G1350', 'Immediately leaving the nets — radical abandonment of livelihood; Markan euthys again stresses urgency of response.', 129),
  (20, 'ἀφέντες τὸν πατέρα', 'aphentes ton patera', 'G863/G3962', 'Leaving the father — discipleship cost in an honor-shame society; Zebedee left with hired servants, softening the break.', 130),
  (21, 'Καφαρναούμ', 'Kapharnaoum', 'G2584', 'Capernaum — "village of Nahum" on NW shore of Sea of Galilee; Jesus''s ministry headquarters (Matt 4:13).', 131),
  (21, 'εἰσελθὼν εἰς τὴν συναγωγὴν ἐδίδασκεν', 'eiselthōn eis tēn synagōgēn edidasken', 'G4864/G1321', 'Entering the synagogue, taught — imperfect: habitual teaching; synagogue as accessible platform for early ministry.', 132),
  (22, 'ἐξεπλήσσοντο', 'exeplēssonto', 'G1605', 'Were astonished — ekplēssomai: struck out of oneself; speechless amazement; imperfect passive signals sustained impact.', 133),
  (22, 'οὐχ ὡς οἱ γραμματεῖς', 'ouch hōs hoi grammateis', 'G1122', 'Not as the scribes — scribes cited prior teachers; Jesus teaches on his own authority, like a new Moses/Sinai voice.', 134),
  (23, 'πνεῦμα ἀκάθαρτον', 'pneuma akatharton', 'G4151/G169', 'Unclean spirit — Mark''s preferred term over "demon"; ritual impurity language; synagogue itself not exempt from spiritual corruption.', 135),
  (24, 'τί ἡμῖν καὶ σοί', 'ti hēmin kai soi', 'G5101', '"What to us and to thee?" — Semitic idiom of hostile disengagement (Judg 11:12; 1 Kgs 17:18); demon recoils from holiness.', 136),
  (25, 'φιμώθητι', 'phimōthēti', 'G5392', '"Be muzzled!" — aorist passive imperative; same command Jesus gives the storm (4:39); demonic and cosmic chaos share one master.', 137),
  (26, 'σπαράξαν', 'sparaxan', 'G4682', 'Convulsing — violent shaking; demon''s parting display of resistance before expulsion.', 138),
  (27, 'διδαχὴ καινή', 'didachē kainē', 'G1322/G2537', 'New teaching — kainē: qualitatively new, fresh in kind; authenticated not by novelty of ideas but by exorcistic power.', 139),
  (31, 'κρατήσας τῆς χειρὸς', 'kratēsas tēs cheiros', 'G2902/G5495', 'Taking the hand — physical touch despite ritual cautions; tender personal gesture typical of Mark''s Jesus.', 140),
  (31, 'διηκόνει αὐτοῖς', 'diēkonei autois', 'G1247', 'Served them — imperfect; instantaneous restoration demonstrated by immediate resumption of hospitality; paradigm of healing''s purpose.', 141),
  (32, 'ὀψίας δὲ γενομένης ὅτε ἔδυ ὁ ἥλιος', 'opsias de genomenēs hote edy ho hēlios', 'G3798/G1416/G2246', 'When evening came, when the sun had set — Sabbath ended at sundown; crowds now free to carry the sick (cf. v.21 Sabbath).', 142),
  (34, 'οὐκ ἤφιεν λαλεῖν', 'ouk ēphien lalein', 'G863/G2980', 'Would not let them speak — imperfect: persistent silencing; "messianic secret" theme: premature disclosure risks misunderstanding.', 143),
  (35, 'πρωῒ ἔννυχα λίαν', 'prōi ennycha lian', 'G4404/G1773/G3029', 'Very early, while still night — compound expression; before dawn; Jesus prioritises prayer over sleep and popularity.', 144),
  (35, 'ἔρημον τόπον', 'erēmon topon', 'G2048/G5117', 'Solitary place — erēmos again; place of encounter with God; pattern of retreat for prayer (6:46; 14:32-42).', 145),
  (38, 'κωμοπόλεις', 'kōmopoleis', 'G2969', 'Neighbouring towns — hapax in NT; village-cities, settlements larger than a kōmē, smaller than a polis; programmatic itinerancy.', 146),
  (38, 'εἰς τοῦτο γὰρ ἐξῆλθον', 'eis touto gar exēlthon', 'G1831', '"For this I came forth" — conscious sense of mission; exerchomai may hint at coming from the Father (cf. John 16:28).', 147),
  (40, 'λεπρός', 'lepros', 'G3015', 'Leper — broad term for visible skin disease rendering one ceremonially unclean (Lev 13-14); social and religious outcast.', 148),
  (40, 'γονυπετῶν', 'gonypetōn', 'G1120', 'Kneeling — present participle; posture of supplication and reverence despite ritual distance required of lepers.', 149),
  (41, 'ἁψάμενος', 'hapsamenos', 'G680', 'Having touched — aorist middle; Jesus touches the untouchable; cleanness flows from him outward rather than impurity contaminating inward.', 150),
  (41, 'θέλω, καθαρίσθητι', 'thelō, katharisthēti', 'G2309/G2511', '"I will; be cleansed" — volitional answer to leper''s conditional "if you will"; instantaneous cleansing by divine word.', 151),
  (43, 'ἐμβριμησάμενος', 'embrimēsamenos', 'G1690', 'Sternly charged — embrimaomai: snort like a horse; deep emotion, almost anger; used also of Jesus at Lazarus''s tomb (John 11:33).', 152),
  (44, 'εἰς μαρτύριον αὐτοῖς', 'eis martyrion autois', 'G3142', 'For a testimony to them — priestly verification per Lev 14 would be evidence Messiah had come; public authentication of the miracle.', 153),
  (45, 'διαφημίζειν τὸν λόγον', 'diaphēmizein ton logon', 'G1310/G3056', 'Publish the word — "word" here = news of the healing, but Mark hints at the larger gospel logos about to spread.', 154),
  (45, 'φανερῶς εἰσελθεῖν', 'phanerōs eiselthein', 'G5320/G1525', 'Openly enter — the cleansed leper reenters society while Jesus is now pushed outside; reversal theme.', 155)
) AS w(verse_number, original_word, transliteration, strongs_number, meaning, word_order)
WHERE b.name = 'Mark' AND c.chapter_number = 1 AND v.verse_number = w.verse_number
...
CROSS JOIN (VALUES
  ...
  (4, 'Acts 13:24', 100),
  (4, 'Acts 19:4', 101),
  (4, 'Jeremiah 31:34', 102),
  (5, 'Matthew 3:5-6', 100),
  (5, 'John 3:23', 101),
  (6, '2 Kings 1:8', 100),
  (6, 'Zechariah 13:4', 101),
  (6, 'Leviticus 11:22', 102),
  (7, 'John 1:27', 100),
  (7, 'Acts 13:25', 101),
  (8, 'Joel 2:28-29', 100),
  (8, 'Acts 1:5', 101),
  (8, 'Acts 2:1-4', 102),
  (8, 'Ezekiel 36:25-27', 103),
  (9, 'Matthew 3:13-17', 100),
  (9, 'Luke 3:21-22', 101),
  (10, 'Isaiah 64:1', 100),
  (10, 'Genesis 1:2', 101),
  (10, 'John 1:32-34', 102),
  ...
  (12, 'Matthew 4:1', 100),
  (12, 'Luke 4:1-2', 101),
  (13, 'Deuteronomy 8:2', 100),
  (13, 'Hebrews 2:17-18', 101),
  (13, 'Isaiah 11:6-9', 102),
  (13, 'Psalm 91:11-13', 103),
  (14, 'Mark 6:17', 100),
  (14, 'Matthew 14:3-4', 101),
  (15, 'Daniel 2:44', 100),
  (15, 'Ephesians 1:10', 101),
  (15, 'Galatians 4:4', 102),
  (16, 'Matthew 4:18', 100),
  (17, 'Jeremiah 16:16', 100),
  (17, 'Ezekiel 47:10', 101),
  (18, '1 Kings 19:19-21', 100),
  (18, 'Luke 5:11', 101),
  (19, 'Matthew 4:21', 100),
  (20, 'Matthew 10:37', 100),
  (20, 'Deuteronomy 33:9', 101),
  (21, 'Matthew 4:13', 100),
  (21, 'Luke 4:31', 101),
  (22, 'Matthew 7:28-29', 100),
  (22, 'John 7:46', 101),
  (23, 'Luke 4:33', 100),
  (24, 'James 2:19', 100),
  (24, 'Mark 5:7', 101),
  ...
  (39, 'Matthew 4:23', 100),
  (39, 'Luke 4:44', 101),
  (40, 'Leviticus 13:45-46', 100),
  (40, 'Matthew 8:2', 101),
  (40, 'Luke 5:12', 102),
  (41, '2 Kings 5:10-14', 100),
  (41, 'Matthew 8:3', 101),
  (41, 'Hebrews 4:15', 102),
  (42, 'Luke 17:14', 100),
  (43, 'John 11:33', 100),
  (43, 'John 11:38', 101),
  (44, 'Leviticus 14:1-32', 100),
  (44, 'Matthew 8:4', 101),
  (44, 'Luke 17:14', 102),
  (45, 'Luke 5:15-16', 100),
  (45, 'Mark 2:13', 101),
...
WHERE b.name = 'Mark' AND c.chapter_number = 1 AND v.verse_number = x.verse_number
ON CONFLICT DO NOTHING;
