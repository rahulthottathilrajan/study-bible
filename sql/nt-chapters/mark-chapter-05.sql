...
-- MARK CHAPTER 5 — BACKFILL (additional word_studies + cross_references)
...
JOIN books b ON c.book_id = b.id
CROSS JOIN (VALUES
  (1, 'εἰς τὴν χώραν τῶν Γερασηνῶν', 'eis tēn chōran tōn Gerasēnōn', 'G5561/G1046', 'Country of the Gerasenes — textual variants Gadarenes/Gergesenes; Decapolis region east of Galilee; Gentile territory.', 100),
  (2, 'ἐκ τῶν μνημείων', 'ek tōn mnēmeiōn', 'G3419', 'Out of the tombs — rock-cut tomb caves, ritually unclean; total defilement: corpse-impurity, evil spirit, Gentile soil.', 101),
  (3, 'οὐδὲ ἁλύσει οὐκέτι οὐδεὶς ἐδύνατο αὐτὸν δῆσαι', 'oude halysei ouketi oudeis edynato auton dēsai', 'G254/G1210', 'No one could bind him even with a chain — piled negatives emphasize total human failure; strong-man motif inverted (cf. 3:27).', 102),
  (4, 'πέδαις καὶ ἁλύσεσι... διεσπάσθαι', 'pedais kai halysesi... diespasthai', 'G3976/G254/G1288', 'Foot-shackles and chains... torn apart — diaspaō: pull asunder; superhuman strength characteristic of demonic possession.', 103),
  (5, 'κράζων καὶ κατακόπτων ἑαυτὸν λίθοις', 'krazōn kai katakoptōn heauton lithois', 'G2896/G2629/G3037', 'Crying out and gashing himself with stones — self-mutilation; demon-driven destruction of the divine image.', 104),
  (6, 'ἔδραμεν καὶ προσεκύνησεν αὐτῷ', 'edramen kai prosekynēsen autō', 'G5143/G4352', 'Ran and worshiped him — prosekyneō: full prostration; demon compelled to acknowledge Christ''s supremacy.', 105),
  (7, 'υἱὲ τοῦ θεοῦ τοῦ ὑψίστου', 'huie tou theou tou hypsistou', 'G5207/G2316/G5310', 'Son of the Most High God — hypsistos: common Gentile title for supreme deity (Dan 3:26, Acts 16:17); correct demonic christology.', 106),
  (7, 'ὁρκίζω σε τὸν θεόν', 'horkizō se ton theon', 'G3726', '"I adjure you by God" — reversed exorcism: demon attempts to bind Jesus by oath; desperate reversal of normal exorcistic formula.', 107),
  (7, 'μή με βασανίσῃς', 'mē me basanisēs', 'G928', 'Do not torment me — basanizō: test by touchstone, hence torture; demonic awareness of eschatological punishment (cf. Matt 8:29).', 108),
  (8, 'ἔξελθε τὸ πνεῦμα τὸ ἀκάθαρτον', 'exelthe to pneuma to akatharton', 'G1831', '"Come out, unclean spirit!" — imperfect narration: Jesus had been saying; exorcism already under way when demon pleads.', 109),
  (9, 'τί ὄνομά σοι', 'ti onoma soi', 'G3686', '"What is your name?" — in ancient exorcism, knowing a demon''s name conferred power over it; Jesus follows convention.', 110),
  (9, 'πολλοί ἐσμεν', 'polloi esmen', 'G4183', '"We are many" — collective self-description; plural possession underscores the uncontainable scale of the affliction.', 111),
  (10, 'παρεκάλει... ἔξω τῆς χώρας', 'parekalei... exō tēs chōras', 'G3870/G5561', 'Begged... out of the country — demons attached to place as well as person; fear of being sent to the abyss (cf. Luke 8:31).', 112),
  (11, 'ἀγέλη χοίρων', 'agelē choirōn', 'G34/G5519', 'Herd of swine — unclean animals (Lev 11:7); Gentile pastoral economy; setting underlines ritual impurity of the region.', 113),
  (12, 'πέμψον ἡμᾶς εἰς τοὺς χοίρους', 'pempson hēmas eis tous choirous', 'G3992', 'Send us into the swine — any disembodiment preferable to expulsion; unclean spirits seek unclean hosts.', 114),
  (13, 'ὥρμησεν ἡ ἀγέλη κατὰ τοῦ κρημνοῦ', 'hōrmēsen hē agelē kata tou krēmnou', 'G3729/G2911', 'The herd rushed down the steep bank — hormaō: dash violently; demon-possessed swine reveal the self-destructive end of evil.', 115),
  (13, 'ὡς δισχίλιοι', 'hōs dischilioi', 'G1367', 'About 2,000 — Roman military legion was ~6,000 soldiers; large-scale material loss quantified by an eyewitness detail.', 116),
  (14, 'οἱ βόσκοντες αὐτοὺς ἔφυγον', 'hoi boskontes autous ephygon', 'G1006/G5343', 'Those feeding them fled — pastoral staff abandon post; news carried to city and countryside; multiple witnesses.', 117),
  (15, 'ἱματισμένον καὶ σωφρονοῦντα', 'himatismenon kai sōphronounta', 'G2439/G4993', 'Clothed and in his right mind — three restorations: clothed (dignity), seated (stilled), sane; portrait of complete salvation.', 118),
  (15, 'ἐφοβήθησαν', 'ephobēthēsan', 'G5399', 'They were afraid — not joy at deliverance but terror at the power displayed; economic + supernatural threat.', 119),
  (17, 'ἤρξαντο παρακαλεῖν αὐτὸν ἀπελθεῖν', 'ērxanto parakalein auton apelthein', 'G3870/G565', 'They began to beg him to depart — inversion of typical response; the region chooses pigs over the Prince of Peace.', 120),
  (18, 'ἵνα μετ''αὐτοῦ ᾖ', 'hina met autou ē', 'G3326', 'That he might be with him — same formula used for apostolic calling (3:14); delivered man asks for discipleship.', 121),
  (19, 'ἀπάγγειλον αὐτοῖς ὅσα ὁ κύριός σοι πεποίηκεν', 'apangeilon autois hosa ho kyrios soi pepoiēken', 'G518/G4160', '"Declare what the Lord has done for you" — Jesus assigns missionary role to this Gentile; first commissioned evangelist to Decapolis.', 122),
  (19, 'ἠλέησέν σε', 'ēleēsen se', 'G1653', 'Had mercy on you — eleos: Heb. chesed; covenant mercy extended to a Gentile demoniac; foreshadows universal mission.', 123),
  (20, 'ἐν τῇ Δεκαπόλει', 'en tē Dekapolei', 'G1179', 'In the Decapolis — league of ten Hellenistic cities east/south of Sea of Galilee; cultural Greco-Roman; later site of Christian return (7:31; 8:1-10).', 124),
  (22, 'ἀρχισυναγώγων', 'archisynagōgōn', 'G752', 'Ruler of the synagogue — lay official responsible for order of services; man of standing in Jewish community.', 125),
  (22, 'Ἰάϊρος', 'Iairos', 'G2383', 'Jairus — Hebrew ya''ir: "he enlightens" or "he awakens"; name may portend the awakening he will witness.', 126),
  (23, 'ἐσχάτως ἔχει', 'eschatōs echei', 'G2079', 'Is at the point of death — eschatōs: extremely, at the final stage; adverb from eschatos (last).', 127),
  (23, 'ἐπιθῇς τὰς χεῖρας αὐτῇ', 'epithēs tas cheiras autē', 'G2007/G5495', 'Lay your hands on her — touch-mediated healing, ordinary expectation; contrasts with what Jesus does ultimately (he does more).', 128),
  (25, 'ῥύσει αἵματος', 'rhysei haimatos', 'G4511/G129', 'A flow of blood — gynecological haemorrhage; Lev 15:25-27 renders her continuously unclean, isolated from temple and society.', 129),
  (26, 'πολλὰ παθοῦσα ὑπὸ πολλῶν ἰατρῶν', 'polla pathousa hypo pollōn iatrōn', 'G3958/G2395', 'Having suffered much under many physicians — Mark''s stinging verdict; Luke (the physician) softens this (Luke 8:43).', 130),
  (26, 'μηδὲν ὠφεληθεῖσα ἀλλὰ μᾶλλον εἰς τὸ χεῖρον ἐλθοῦσα', 'mēden ōphelētheisa alla mallon eis to cheiron elthousa', 'G3762/G5623/G5501', 'Not bettered but grown worse — compound failure: financial ruin + deteriorating condition.', 131),
  (27, 'ὄπισθεν... ἥψατο τοῦ ἱματίου αὐτοῦ', 'opisthen... hēpsato tou himatiou autou', 'G3693/G680/G2440', 'Behind... touched his garment — stealth approach; her impurity would defile anyone she touched; she expects only residual power.', 132),
  (28, 'ἐὰν ἅψωμαι', 'ean hapsōmai', 'G680', 'If I touch — ean + aorist subjunctive: conditional faith; incomplete theology yet sufficient faith.', 133),
  (28, 'τοῦ κρασπέδου', 'tou kraspedou', 'G2899', 'The hem/fringe (Matthew parallel) — tzitzit, tassels commanded in Num 15:38; Mal 4:2 "wings" of the Sun of Righteousness.', 134),
  (29, 'ἐξηράνθη ἡ πηγὴ τοῦ αἵματος', 'exēranthē hē pēgē tou haimatos', 'G3583/G4077/G129', 'The fountain of her blood dried up — pēgē: spring, source; bodily language of cessation; instantaneous healing.', 135),
  (29, 'ἰάται ἀπὸ τῆς μάστιγος', 'iatai apo tēs mastigos', 'G2390/G3148', 'Healed of the scourge — mastix (cf. 3:10): illness seen as whip-like affliction; healed in essence and in sensation.', 136),
  (30, 'ἐπιγνοὺς ἐν ἑαυτῷ... δύναμιν ἐξελθοῦσαν', 'epignous en heautō... dynamin exelthousan', 'G1921/G1411/G1831', 'Perceiving power had gone out from him — not depletion but transaction; Jesus aware of faith''s specific appropriation.', 137),
  (31, 'συνθλίβοντά σε', 'synthlibonta se', 'G4918', 'Pressing against you — synthlibō: squeeze together; disciples note the crowd but miss the distinct touch of faith.', 138),
  (33, 'φοβηθεῖσα καὶ τρέμουσα', 'phobētheisa kai tremousa', 'G5399/G5141', 'Fearing and trembling — exposed breach of purity laws plus awe at power received; double emotion.', 139),
  (33, 'εἶπεν αὐτῷ πᾶσαν τὴν ἀλήθειαν', 'eipen autō pasan tēn alētheian', 'G3956/G225', 'Told him the whole truth — full confession draws private healing into public testimony; witness completed.', 140),
  (34, 'θυγάτηρ', 'thygatēr', 'G2364', 'Daughter — only place in the gospels Jesus addresses a woman this way; familial adoption into the household of faith.', 141),
  (34, 'ὕπαγε εἰς εἰρήνην', 'hypage eis eirēnēn', 'G5217/G1515', '"Go in peace" — Hebrew lek l''shalom; wholeness restored; more than cessation of fear.', 142),
  (35, 'τί ἔτι σκύλλεις τὸν διδάσκαλον', 'ti eti skylleis ton didaskalon', 'G4660/G1320', '"Why trouble the Teacher further?" — skyllō: flay, trouble; death framed as the final limit, beyond Jesus''s reach.', 143),
  (36, 'παρακούσας', 'parakousas', 'G3878', 'Overhearing — possibly "disregarding" the news; Jesus bypasses the deflating word to sustain Jairus''s faith.', 144),
  (36, 'μὴ φοβοῦ μόνον πίστευε', 'mē phobou monon pisteue', 'G3361/G5399/G3441/G4100', '"Fear not, only believe" — present imperatives: stop fearing, keep believing; sustained trust against present evidence.', 145),
  (38, 'θόρυβον καὶ κλαίοντας καὶ ἀλαλάζοντας', 'thorybon kai klaiontas kai alalazontas', 'G2351/G2799/G214', 'Tumult, weeping, and wailing — professional mourners often hired; alalazō: ululating cry; ritualised lamentation.', 146),
  (39, 'οὐκ ἀπέθανεν ἀλλὰ καθεύδει', 'ouk apethanen alla katheudei', 'G599/G2518', '"Not dead but sleeping" — euphemism anticipates resurrection; death redefined as temporary sleep in Christ''s presence.', 147),
  (40, 'κατεγέλων αὐτοῦ', 'kategelōn autou', 'G2606', 'They laughed at him — imperfect: mocked derisively; immediate transition from wailing to scorn exposes shallowness.', 148),
  (41, 'ταλιθὰ κοῦμ', 'talitha koum', 'G5008/G2891', 'Talitha koum — Aramaic "little girl, arise"; Mark preserves Jesus''s actual speech; tender diminutive talya.', 149),
  (42, 'ἦν γὰρ ἐτῶν δώδεκα', 'ēn gar etōn dōdeka', 'G1427', 'She was twelve years old — parallel to hemorrhaging woman''s 12 years (v.25); Mark brackets a 12-year suffering with a 12-year life.', 150),
  (42, 'ἐξέστησαν ἐκστάσει μεγάλῃ', 'exestēsan ekstasei megalē', 'G1839/G1611', 'Were beside themselves with great amazement — cognate accusative intensifies; ekstasis: standing outside oneself; proper awe.', 151),
  (43, 'διεστείλατο αὐτοῖς πολλὰ', 'diesteilato autois polla', 'G1291', 'Charged them strictly — diastellomai: issue sharp instructions; messianic secret reinforced despite obvious public knowledge.', 152),
  (43, 'δοθῆναι αὐτῇ φαγεῖν', 'dothēnai autē phagein', 'G1325/G5315', 'That something be given her to eat — practical pastoral detail; resurrection proven by appetite (cf. Luke 24:41-43).', 153)
) AS w(verse_number, original_word, transliteration, strongs_number, meaning, word_order)
WHERE b.name = 'Mark' AND c.chapter_number = 5 AND v.verse_number = w.verse_number
...
CROSS JOIN (VALUES
  ...
  (2, 'Isaiah 65:4', 100),
  (3, 'Mark 3:27', 100),
  (4, '2 Timothy 2:25-26', 100),
  (5, '1 Kings 18:28', 100),
  (5, 'Isaiah 8:19', 101),
  (6, 'James 2:19', 100),
  (6, 'Philippians 2:10-11', 101),
  (7, 'Luke 4:34', 100),
  (7, 'Acts 16:17', 101),
  (7, 'Genesis 14:18-20', 102),
  (7, 'Matthew 8:29', 103),
  (8, 'Mark 1:25', 100),
  (8, 'Mark 9:25', 101),
  (9, 'Matthew 26:53', 100),
  (10, 'Luke 8:31', 100),
  (10, 'Revelation 20:1-3', 101),
  (11, 'Leviticus 11:7', 100),
  (11, 'Deuteronomy 14:8', 101),
  (12, 'Job 1:10-12', 100),
  (13, 'Revelation 12:12', 100),
  (14, 'Luke 8:34', 100),
  (15, 'Luke 10:39', 100),
  (15, 'Acts 22:3', 101),
  (15, 'Colossians 1:13', 102),
  (16, 'Mark 5:13', 100),
  (17, 'Luke 8:37', 100),
  (17, 'Acts 16:39', 101),
  (18, 'Luke 8:38', 100),
  ...
  (23, 'Mark 7:32', 101),
  (24, 'Luke 8:42', 100),
  (25, 'Leviticus 15:25-27', 100),
  (26, 'Luke 8:43', 100),
  (27, 'Mark 3:10', 100),
  (27, 'Mark 6:56', 101),
  (28, 'Numbers 15:38-40', 100),
  (28, 'Malachi 4:2', 101),
  (28, 'Acts 19:12', 102),
  (29, 'Mark 3:10', 100),
  (30, 'Luke 6:19', 100),
  ...
  (34, 'Matthew 9:22', 100),
  (34, 'Luke 7:50', 101),
  (34, '1 Samuel 1:17', 102),
  (35, 'John 11:21', 100),
  (36, 'Isaiah 43:1', 100),
  (36, 'John 11:40', 101),
  (36, '2 Chronicles 20:20', 102),
  (37, 'Mark 9:2', 100),
  (37, 'Mark 14:33', 101),
  (38, 'Jeremiah 9:17-20', 100),
  (38, 'Matthew 9:23', 101),
  (39, 'John 11:11-13', 100),
  (39, 'Acts 7:60', 101),
  (39, '1 Thessalonians 4:13-14', 102),
  (40, 'Genesis 17:17', 100),
  (40, 'Luke 8:53', 101),
  (41, 'Luke 7:14', 100),
  (41, 'John 11:43', 101),
  (41, 'Acts 9:40', 102),
...
WHERE b.name = 'Mark' AND c.chapter_number = 5 AND v.verse_number = x.verse_number
ON CONFLICT DO NOTHING;
